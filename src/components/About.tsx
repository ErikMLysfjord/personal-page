...
const About: React.FC = () => {
  ...
  return (
    <div id='about' className='w-full h-full snap-y'>
      <div
        id='circle'
        style={Circle}
        className='w-full h-full bg-minLilla mx-auto relative z-0 snap-center flex flex-row flex-wrap justify-center p-10  text-center text-white'
      >
